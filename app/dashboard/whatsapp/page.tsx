...
export default function WhatsAppPage() {
  ...
  return (
    <div className="wire p-4 sm:p-6 lg:p-8 space-y-6 max-w-6xl">
          ...
          {!inProgress && (
            <>
              <Button
                ...
                size="sm"
                onClick={startImport}
                className={`gap-1.5 ${!snapshot ? "bg-[var(--w-carbon)] text-white hover:bg-[var(--w-ink)]" : ""}`}
              >
                {snapshot ? (
                  ...
                  {profileProgress && (
                    <div className="flex flex-col items-end gap-0.5 w-48">
                      ...
                      <div className="w-full h-1 rounded-full bg-muted overflow-hidden">
                        <div
                          className="h-full bg-[var(--w-carbon)] rounded-full transition-all duration-300"
