...
export function SyncBanner() {
  ...
  return (
    <div className="sticky top-0 z-30 flex items-center gap-2.5 px-4 py-2 text-[0.8125rem] border-b border-[var(--w-rule)] bg-[#0B1730]/95 backdrop-blur supports-[backdrop-filter]:bg-[#0B1730]/80">
      <span className="relative flex h-2 w-2 shrink-0">
        <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[var(--w-carbon)] opacity-60" />
        <span className="relative inline-flex h-2 w-2 rounded-full bg-[var(--w-carbon)]" />
      </span>
