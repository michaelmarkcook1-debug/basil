...
const INLINE = [
  ...
  { re: /\[([^\]]+)\]\((https?:\/\/[^\s)]+)\)/, render: (m: string, key: number, g2?: string) => <a key={key} href={g2} target="_blank" rel="noopener noreferrer" className="text-[color:var(--w-carbon)] underline underline-offset-2 hover:opacity-80">{m}</a> },
