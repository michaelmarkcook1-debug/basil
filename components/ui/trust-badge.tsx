...
const SOURCE_STYLES: Record<KnownSource, string> = {
  ...
  Chat:      "bg-[oklch(0.96_0.02_85)] text-[oklch(0.45_0.12_85)] border-[oklch(0.88_0.04_85)] dark:bg-[oklch(0.16_0.03_85)] dark:text-[color:var(--w-carbon)] dark:border-[oklch(0.24_0.05_85)]",
};
